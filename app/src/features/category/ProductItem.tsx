  ...
  return (
    <View style={[styles.container, { marginRight: isSecondColumn ? 10 : 0 }]}>
      ...
      <View style={styles.content}>
        ...
        <CustomText variant='h8' fontFamily={Fonts.Medium} numberOfLines={2} style={{ marginVertical: 4 }}>{item.name}</CustomText>
        <View style={styles.priceConatiner}>
          <View>
            <CustomText variant='h8' fontFamily={Fonts.Medium}>
              ₹{item?.price}
            </CustomText>
            <CustomText variant='h9' fontFamily={Fonts.Medium} style={{ opacity: 0.8, textDecorationLine: "line-through" }}>
              ₹{item.discountPrice}
            </CustomText>
          </View>
        </View>
